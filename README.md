            ...
            algebra: {
                basic: Array.from({ length: 50 }, (_, i) => {
                    ...
                    const types = [
                        ...
                        {
                            question: `Simplifica: <strong>${a}x + ${b} + ${c}x + ${b}</strong>`,
                            options: [
                                { text: `${a+c}x + ${b*2}`, correct: true },
                                { text: `${a+c}x + ${b}`, correct: false },
                                { text: `${a*c}x + ${b*2}`, correct: false },
                                { text: `${a+c}x`, correct: false }
                            ],
                            feedbackCorrect: `¡Correcto! La expresión simplificada es ${a+c}x + ${b*2}.`,
                            feedbackIncorrect: `Incorrecto. La solución correcta es ${a+c}x + ${b*2}.`
                        },
                        {
                            question: `Resuelve: <strong>${a}x - ${b} = ${c}x + ${b}</strong>`,
                            options: [
                                { text: `x = ${(b*2)/(a-c)}`, correct: true },
                                { text: `x = ${(b)/(a-c)}`, correct: false },
                                { text: `x = ${(b*2)/(a+c)}`, correct: false },
                                { text: `x = ${(b)/(a+c)}`, correct: false }
                            ],
                            feedbackCorrect: `¡Correcto! La solución es x = ${(b*2)/(a-c)}.`,
                            feedbackIncorrect: `Incorrecto. La solución correcta es x = ${(b*2)/(a-c)}.`
                        },
                        {
                ...
                intermediate: Array.from({ length: 50 }, (_, i) => {
                    ...
                    const types = [
                        {
                            question: `Resuelve el sistema: <strong>${a}x + ${b}y = ${c}, ${d}x + ${a}y = ${b}</strong>`,
                            options: [
                                { text: `x = ${(c*a - b*b)/(a*a - b*d)}, y = ${(a*b - c*d)/(a*a - b*d)}`, correct: true },
                                { text: `x = ${(c*a + b*b)/(a*a - b*d)}, y = ${(a*b + c*d)/(a*a - b*d)}`, correct: false },
                                { text: `x = ${(c*a - b*b)/(a*a + b*d)}, y = ${(a*b - c*d)/(a*a + b*d)}`, correct: false },
                                { text: `x = ${(c*a + b*b)/(a*a + b*d)}, y = ${(a*b + c*d)/(a*a + b*d)}`, correct: false }
                            ],
                            feedbackCorrect: `¡Correcto! La solución es x = ${(c*a - b*b)/(a*a - b*d)}, y = ${(a*b - c*d)/(a*a - b*d)}.`,
                            feedbackIncorrect: `Incorrecto. La solución correcta es x = ${(c*a - b*b)/(a*a - b*d)}, y = ${(a*b - c*d)/(a*a - b*d)}.`
                        },
                        {
            ...
            geometry: {
                basic: Array.from({ length: 50 }, (_, i) => {
                    ...
                    const types = [
                        ...
                        {
                            question: `Calcula el área de un trapecio con bases ${a} cm y ${b} cm, y altura ${a} cm.`,
                            options: [
                                { text: `${((a+b)*a/2).toFixed(2)} cm²`, correct: true },
                                { text: `${(a*b*a).toFixed(2)} cm²`, correct: false },
                                { text: `${(a+b+a).toFixed(2)} cm²`, correct: false },
                                { text: `${(2*(a+b)).toFixed(2)} cm²`, correct: false }
                            ],
                            feedbackCorrect: `¡Correcto! El área del trapecio es (base1 + base2) × altura / 2 = (${a} + ${b}) × ${a} / 2 = ${((a+b)*a/2).toFixed(2)} cm².`,
                ...
                intermediate: Array.from({ length: 50 }, (_, i) => {
                    ...
                    const types = [
                        ...
                        {
                            question: `Calcula el área de un rombo con diagonales ${a} cm и ${b} cm.`,
                            options: [
                        ...
                        {
                            question: `Calcula el área de un polígono regular de ${a} lados, con apotema ${b} cm y lado ${a} cm.`,
                            options: [
                                { text: `${(a*a*b/2).toFixed(2)} cm²`, correct: true },
                                { text: `${(a*b*a).toFixed(2)} cm²`, correct: false },
                                { text: `${(a*b).toFixed(2)} cm²`, correct: false },
                                { text: `${(a*a).toFixed(2)} cm²`, correct: false }
                            ],
                            feedbackCorrect: `¡Correcto! El área del polígono regular es (perímetro × apotema) / 2 = (${a} × ${a} × ${b}) / 2 = ${(a*a*b/2).toFixed(2)} cm².`,
                ...
                advanced: Array.from({ length: 50 }, (_, i) => {
                    ...
                    const types = [
                        ...
                        {
                            question: `En un triángulo, el lado a mide ${a} cm, el lado b mide ${a} cm y el ángulo entre ellos es de ${angle}°. Calcula el área.`,
                            options: [
                                { text: `${(0.5*a*a*Math.sin(angle * Math.PI/180)).toFixed(2)} cm²`, correct: true },
                                { text: `${(a*a).toFixed(2)} cm²`, correct: false },
                                { text: `${(0.5*a*a).toFixed(2)} cm²`, correct: false },
                                { text: `${(a*a*Math.sin(angle * Math.PI/180)).toFixed(2)} cm²`, correct: false }
                            ],
                            feedbackCorrect: `¡Correcto! El área es ½ × a × b × sin(θ) = 0.5 × ${a} × ${a} × sin(${angle}°) = ${(0.5*a*a*Math.sin(angle * Math.PI/180)).toFixed(2)} cm².`,
            ...
            arithmetic: {
                ...
                advanced: Array.from({ length: 50 }, (_, i) => {
                    ...
                    const types = [
                        ...
                        {
                            question: `Calcula la media aritmética de ${a}, ${b}, ${c} y ${a}`,
                            options: [
                                { text: `${(a+b+c+a)/4}`, correct: true },
                                { text: `${(a*b*c*a)/4}`, correct: false },
                                { text: `${(a+b+c+a)}`, correct: false },
                                { text: `${(a+b)/(c+a)}`, correct: false }
                            ],
                            feedbackCorrect: `¡Correcto! Media = (${a} + ${b} + ${c} + ${a}) / 4 = ${a+b+c+a} / 4 = ${(a+b+c+a)/4}.`,
                            feedbackIncorrect: `Incorrecto. Media = (${a} + ${b} + ${c} + ${a}) / 4 = ${a+b+c+a} / 4 = ${(a+b+c+a)/4}.`
                        },
                        {
